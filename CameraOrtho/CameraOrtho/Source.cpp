...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//glfwGetFramebufferSize(window, &width, &height); cometado instrução de correção de aspecto (EX 02)
		...
		//ortho = glm::ortho(-10.0f, 10.0f, -10.0f, 10.0f, -1.0f, 1.0f)Mudança de tamanho exercicio 01
		//ortho = glm::ortho( 0.0f, 800.0f, 0.0f, 600.0f, -1.0f, 1.0f);//mudança de tamanha exercicio 02
		ortho = glm::ortho(-1.0f, 1.0f, -1.0f, 1.0f, -1.0f, 1.0f);//mudança de tamanha exercicio 02
